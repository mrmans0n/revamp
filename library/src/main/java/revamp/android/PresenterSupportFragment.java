...
public abstract class PresenterSupportFragment<P extends Presenter<V>, V extends ViewComponent> extends Fragment implements ViewComponent, PresenterFragmentDelegateCallback<V, P>, RetainableStore {
