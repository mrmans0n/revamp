...
public abstract class RevampMvpPresenter<MODEL extends ReleasableModel, VIEW extends ViewComponent> implements Presenter<VIEW> {
  ...
  public RevampMvpPresenter(@NonNull MODEL model) {
    mModel = model;
    Class<?>[] classes = TypeResolver.resolveRawArguments(RevampMvpPresenter.class, getClass());
